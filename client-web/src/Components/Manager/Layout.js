...
const Layout = () => {
  ...
  return (
    <div className="relative bg-[#f8f9fa] font-family-karla flex">
      <aside className=" bg-[#13459c]    w-64 hidden sm:block shadow-xl shadow-gray-400  h-screen overflow-hidden ">
